    ...
    <div class="main_wrapper">
        ...
        <div class="content_wrapper">
            ...
            <div id="shopping_cart">
                ...
                ?>
                <b style="color:teal">Shopping Cart - </b> Total Items: <?php total_items(); ?> Total Price: $<?php total_price() ?>.00 <a href="index.php" style="color:teal">Back to Shop</a>
            ...
            ?>
                ...
                <!-- <br> -->
                    <form action="" method="post" enctype="multipart/form-data">
                        <table alight ="center" width="700" bgcolor="skyblue">
                            <tr align="center">
                    ...
                    <tr align="center">
                            ...
                            <td><input type="text" size="4" name="qty" placeholder="1" value="<?php echo $_SESSION['qty']?>"/></td>
                            <?php
                                if(isset($_POST['update_cart'])) {
                                    $qty = $_POST['qty'];
                                    $update_qty = "update cart qty='$qty'";
                    ...
                    <tr align="center">
                            ...
                            <td><a href="index.php" style="text-decoration:none; color:black"><button>Continue shopping</a></button></td>
